    ...
    <div class="container mx-auto px-4 max-w-6xl">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                ...
                {{-- 1. TOMBOL EDIT PEMELIHARAAN --}}
                {{-- Pastikan nama route 'admin.maintenances.edit' sesuai dengan route Anda --}}
                <a href="{{ route('employee.maintenances.edit', $maintenance->id) }}" wire:navigate
                    class="inline-flex justify-center items-center px-4 py-2 bg-green-600 rounded-lg text-sm font-medium text-white hover:bg-green-700 transition w-full sm:w-auto shadow-sm order-1 sm:order-1">
                ...
                {{-- 2. TOMBOL KEMBALI --}}
                {{-- Class disesuaikan (py-2, rounded-lg) agar tingginya sama persis dengan tombol edit --}}
                <a href="{{ $backUrl }}"
                    wire:navigate class="group flex items-center justify-center gap-2 w-full sm:w-auto bg-white text-gray-700 py-2 px-6 rounded-lg border border-gray-200 hover:border-blue-400 hover:text-blue-600 transition-all shadow-sm font-medium touch-manipulation order-2 sm:order-2">

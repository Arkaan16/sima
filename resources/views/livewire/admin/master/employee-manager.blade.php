...
>
    ...
    <div>
        @if (session()->has('message'))
            <div wire:key="msg-success" x-data="{ show: true }" x-init="setTimeout(() => show = false, 2000)" x-show="show" 
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                        <tr><td colspan="3" class="px-6 py-8 text-center text-gray-400 italic">Belum ada data karyawan.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
    ...
    <div wire:ignore.self x-show="showFormModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center px-4 py-6 sm:px-6"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg relative z-10 flex flex-col max-h-[90vh] overflow-hidden"
            ...
            <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                <h3 class="text-lg font-bold text-gray-800" x-text="$wire.isEditMode ? 'Edit Karyawan' : 'Tambah Karyawan'"></h3>
                ...
                <form wire:submit.prevent="store">
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="name" placeholder="Nama Karyawan"
    ...
    <div wire:ignore.self x-show="showDeleteModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center px-4"
        ...
        <div class="bg-white rounded-2xl p-6 shadow-2xl sm:max-w-sm w-full z-10 text-center transform transition-all"
            ...
            <p class="text-gray-500 mt-2 text-sm">Anda akan menghapus data karyawan <b x-text="$wire.deleteName"></b>. <br> <span class="text-red-500 font-medium">Tindakan ini tidak dapat dibatalkan.</span></p>

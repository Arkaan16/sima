<div class="container mx-auto px-4">
    <div class="max-w-4xl mx-auto">
        ...
        {{-- 
            PENERAPAN FIX TOMBOL LOADING:
            Menggunakan x-data="{ isSaving: false }" untuk mengunci form.
        --}}
        <form wire:submit="save" 
              x-data="{ isSaving: false }" 
              x-on:submit="isSaving = true">

            {{-- Reset status loading jika ada error validasi --}}
            @if($errors->any())
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            {{-- 
                                KHUSUS EDIT: ASSET TAG READONLY 
                                Class 'bg-gray-100' dan 'cursor-not-allowed' untuk visual lock.
                            --}}
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">
                                    Kode Aset (Tag) <span class="text-gray-400 text-xs font-normal ml-1">(Tidak dapat diubah)</span>
                                </label>
                                <input type="text" 
                                       wire:model="form.asset_tag" 
                                       readonly
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm bg-gray-100 text-gray-500 cursor-not-allowed focus:outline-none transition shadow-sm">
                            </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-start space-x-4">
                            {{-- 
                                LOGIKA PREVIEW KHUSUS EDIT:
                                1. Jika ada upload baru (form.image), tampilkan itu.
                                2. Jika tidak, tampilkan gambar lama (form.assetModel->image) jika ada.
                                3. Jika kosong semua, tampilkan placeholder.
                            --}}
                            <div class="shrink-0">
                                @if ($form->image)
                            ...
                            <div class="w-full">
                                ...
                                <p class="mt-1 text-xs text-gray-500">Maks 2MB (jpeg, jpg/png). Biarkan kosong jika tidak ingin mengubah gambar.</p>
                ...
                {{-- FOOTER ACTION DENGAN FIX IS_SAVING --}}
                <div class="bg-gray-50 px-6 py-4 flex items-center justify-end space-x-3 border-t border-gray-200">
                    ...
                    <button type="submit" 
                        :disabled="isSaving"
                        class="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-sm transition flex items-center justify-center disabled:opacity-75 disabled:cursor-not-allowed min-w-[140px]">

<div class="container mx-auto px-4 py-2 max-w-7xl">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <div class="flex flex-wrap gap-2">
            {{-- Tombol Tambah --}}
            <a href="{{ route('admin.assets.create') }}" wire:navigate class="bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium py-2.5 px-4 rounded-xl transition flex items-center shadow-lg shadow-blue-500/30">
            ...
            <div x-data="{ open: false }" class="relative">
                <button @click="open = !open" type="button" class="bg-purple-100 hover:bg-purple-200 text-purple-700 text-sm font-medium py-2.5 px-4 rounded-xl transition flex items-center border border-purple-200">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {{-- Search (Lebar: Mengambil 2 kolom pada layar besar) --}}
        <div class="relative col-span-1 md:col-span-2">
            <svg class="absolute left-3 top-3 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
            </svg>
            {{-- Placeholder diperbarui sesuai permintaan --}}
            <input wire:model.live.debounce.300ms="search" type="text" 
                placeholder="Cari tag, nama model, lokasi atau ruangan , nomor serial..." 
                class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm shadow-sm transition">
        </div>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                            <div class="flex justify-center space-x-3">
                                ...
                                {{-- Tombol Detail (BIRU) --}}
                                <a href="{{ route('admin.assets.show', $asset->asset_tag) }}" wire:navigate 
    ...
    {{-- MODAL DELETE (Versi Modern Flexbox - Konsisten dengan Employee) --}}
    @if($showDeleteModal)
        ...
        <div class="flex items-center justify-center min-h-screen px-4 text-center">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-2xl transform transition-all sm:max-w-sm w-full z-10 relative border border-gray-100">
                ...
                <div class="mt-8 flex gap-3">
                    <button type="button" wire:click="closeModal" class="flex-1 px-4 py-2.5 bg-gray-100 text-gray-700 rounded-xl font-bold transition hover:bg-gray-200 focus:outline-none">
                        Batal
                    </button>

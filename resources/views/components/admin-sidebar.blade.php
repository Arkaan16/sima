    ...
    <div class="h-full px-4 py-6 overflow-y-auto scrollbar-hide"> 
        ...
        <nav class="space-y-2">
            ...
            <a href="{{ route('admin.maintenances.index') }}" wire:navigate
                class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group
                {{ request()->routeIs('admin.maintenances*') ? 'bg-gray-100 text-indigo-600 font-semibold' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
                
                    <svg class="w-5 h-5 {{ request()->routeIs('admin.maintenances*') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-500' }}" 
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            <a href="{{ route('admin.reports') }}" wire:navigate
                class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group
                {{ request()->routeIs('admin.reports*') ? 'bg-gray-100 text-indigo-600 font-semibold' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
                
                <svg class="w-5 h-5 {{ request()->routeIs('admin.reports*') ? 'text-indigo-600' : 'text-gray-400 group-hover:text-gray-500' }}" 
                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 

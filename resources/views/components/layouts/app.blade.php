...
<head>
    ...
    <style>
        ...
        /* FIX: Class ini mematikan semua animasi saat loading */
        .preload * {
...
{{-- Tambahkan class 'preload' di body --}}
<body class="preload font-sans antialiased bg-gray-50"
      x-data="{ 
    ...
    {{-- Script untuk menghapus class preload setelah halaman siap --}}
    <script>
    ...
    {{-- Panggil GLOBAL Sidebar --}}
    <x-sidebar />
    
    {{-- Main Content Wrapper --}}
    {{-- Pastikan TIDAK ADA class transition disini --}}
    <div id="mainContent" 
         class="min-h-screen"
                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        <button @click="open = !open" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50 transition">
                            ...
                            {{-- Logo/Inisial --}}
                            <div class="w-7 h-7 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold shadow-md">
